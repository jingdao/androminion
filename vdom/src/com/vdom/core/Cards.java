...
public class Cards {
    ...
    static {
		...
		actionCardsAdventures.add(caravanGuard = new ActionCardImpl.Builder(Cards.Type.CaravanGuard,3).addActions(1).addCards(1).description("At the start of your next turn, +1 Coin. When another player plays an Attack card, you may play this from your hand. (+1 Action has no effect if it's not your turn.)").expansion("Adventures").build());
		actionCardsAdventures.add(dungeon = new ActionCardImpl.Builder(Cards.Type.Dungeon,3).addActions(1).description("Now and at the start of your next turn: +2 Cards, then discard 2 cards.").expansion("Adventures").build());
		actionCardsAdventures.add(gear = new ActionCardImpl.Builder(Cards.Type.Gear,3).addCards(2).description("Set aside up to 2 cards from your hand face down. At the start of your next turn, put them into your hand.").expansion("Adventures").build());
		...
		actionCardsAdventures.add(magpie = new ActionCardImpl.Builder(Cards.Type.Magpie,4).addCards(1).addActions(1).isReserve().description("Reveal the top card of your deck.  If it's a Treasure, put it into your hand.  If it's an Action or Victory card, gain a Magpie.").expansion("Adventures").build());
		...
		actionCardsAdventures.add(bridgeTroll = new ActionCardImpl.Builder(Cards.Type.BridgeTroll,5).addBuys(1).description("Each other player takes his -1 Coin token. Now and at the start of your next turn: +1 Buy. While this is in play, cards cost 1 Coin less on your turns, but not less than 0 Coin.").expansion("Adventures").build());
		actionCardsAdventures.add(distantLands = new ActionCardImpl.Builder(Cards.Type.DistantLands,5).isReserve().description("Put this on your Tavern mat. Worth 4 VP if on your Tavern mat at the end of the game (otherwise worth 0 VP).").expansion("Adventures").build());
