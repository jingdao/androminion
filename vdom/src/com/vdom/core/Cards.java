...
public class Cards {
    ...
    static {
		...
		actionCardsAdventures.add(bridgeTroll = new ActionDurationCardImpl.Builder(Cards.Type.BridgeTroll,5).addBuysNextTurn(1).addBuys(1).description("Each other player takes his -1 Coin token. While this is in play, cards cost 1 Coin less on your turns, but not less than 0 Coin.").expansion("Adventures").build());
		...
		actionCardsAdventures.add(hauntedWoods = new ActionDurationCardImpl.Builder(Cards.Type.HauntedWoods,5).addCardsNextTurn(3).description("Until your next turn, when any other player buys a card, he puts his hand on top of his deck in any order.").expansion("Adventures").build());
		...
		actionCardsAdventures.add(swampHag = new ActionDurationCardImpl.Builder(Cards.Type.SwampHag,5).addGoldNextTurn(3).description("Until your next turn, when any other player buys a card, he gains a Curse.").expansion("Adventures").build());
